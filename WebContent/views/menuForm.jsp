								...
								<form id="demo-form2" data-parsley-validate
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12"
											for="menu-name">Menu Name <span class="required">*</span>
										</label>
										<div class="col-sm-4">
											<input type="text" id="menu_name" name="menu-name"
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12"
											for="menu-order">Menu Order <span class="required">*</span>
										</label>
										<div class="col-sm-2">
											<input type="number" id="menu-order" name="menu-order"
												required="required" class="form-control col-md-7 col-xs-12">
										</div>
									</div>
